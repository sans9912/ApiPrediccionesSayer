...
API_KEY = "Lf7nh6iJTYbAqeFChWKYSsM3msyMcaF5aZDQUq67c4jtJcScaQaUnBDvvflh4F6kZK91yFRY5YECjfq4NVf2dJotoobrhjgC8jmy9EkqjXvDYRPeS57s5Vql45LxSZLa"
...
def obtener_predicciones():
    ...
    if not api_key or api_key != f"ApiKey {API_KEY}":
